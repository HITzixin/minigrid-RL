...
class Runner(AbstractEnvRunner):
    ...
    def __init__(self, env, model, ob_space, nsteps=20, gamma=0.99):
...
def learn(policy, env, seed, ob_space, ac_space, nsteps=5, total_timesteps=int(80e6), vf_coef=0.5, ent_coef=0.01, max_grad_norm=0.5, lr=7e-4, lrschedule='linear', epsilon=1e-5, alpha=0.99, gamma=0.99, log_interval=100, save_dir=None):
